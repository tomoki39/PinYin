...
def add_multitone_words_to_ios():
    """Add multi-tone words to iOS version's pinyin_map.json"""
    
    # Path to the iOS version's pinyin_map.json
    json_path = 'PinYin_iOS/PinYin_iOS/Resources/pinyin_map.json'
